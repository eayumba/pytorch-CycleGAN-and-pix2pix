...
TRAINING_DIR = "LFTrain/Training_Wavs_B"
...
def main():
    ...
    for song in os.listdir(TRAINING_DIR):
        ...
        for i, chunk in enumerate(chunks):
            ...
            chunk_name = "LFTrain/WAVs_B/{song_name}{start}.wav".format(song_name = song_name[:(len(song_name) - 4)], start = i*(CHUNK_LENGTH / 1000))
